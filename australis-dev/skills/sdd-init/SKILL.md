...
- In `openspec` mode, follow `${CLAUDE_PLUGIN_ROOT}/skills/_shared/openspec-convention.md` and write file artifacts.
...
- Always build `.australis/skill-registry.md`; also save `skill-registry` to Engram when available.
...
5. Build `.australis/skill-registry.md` using the skill-registry scan rules.
...
- `${CLAUDE_PLUGIN_ROOT}/skills/_shared/openspec-convention.md` — openspec layout and rules.
